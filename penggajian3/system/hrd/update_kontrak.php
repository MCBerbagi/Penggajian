...
<table width="710" class="tbls">
  <tr>
    <td colspan="3"><div align="center">
      <H2>INPUT DATA PEGAWAI KONTRAK</H2></div></td>
  </tr>
  <tr>
    <td width="166">Nip</td>
    <td width="21">:</td>
  ...
  <tr>
    <td>Jabatan</td>
    <td>:</td>
    <td><input name="jabatan" type="text" class="field" value="<?php echo "$kk[jabatan]" ?>" /></td>
  </tr>
  <tr>
    <td>Id_Departemen</td>
    <td>:</td>
    <td><input name="id_departemen" type="text" class="field" value="<?php echo "$kk[id_departemen]" ?>" /></td>
  </tr>
  <tr>
    <td>Departemen</td>
    <td>:</td>
    <td><input name="departemen" type="text" class="field" value="<?php echo "$kk[departemen]" ?>" /></td>
  </tr>
  <!--<tr>
