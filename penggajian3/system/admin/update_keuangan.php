...
<table width="521" border="0" align="center" id="rpt">
  <tr>
    ...
    <div align="center">Ubah Data Keuangan </div>
    </span></td>
  </tr>
  <tr>
    <td width="162">NIP</td>
  ...
  <tr>
    <td>Telepon / Hp </td>
    <td><div align="center"><strong>:</strong></div></td>
    <td><input type="text" name="telp_hrd" size="15"   value="<?php echo $dd[telp_keuangan] ?>"> / <input type="text" name="hp_hrd" size="20"   value="<?php echo $dd[hp_keuangan] ?>">  </tr>
  <tr>
    <td>Email</td>
    <td><div align="center"><strong>:</strong></div></td>
    <td><input type="text" name="email_hrd" size="50"   value="<?php echo $dd[email_keuangan] ?>"></td>
  </tr>
  <tr>
...
if($_POST[tgll]>$dt){
	...
	$ks=mysql_query("update user set 
					...
					hak_akses='keuangan' where nip='$_GET[id]'");
