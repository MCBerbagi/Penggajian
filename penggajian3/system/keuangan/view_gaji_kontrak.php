...
<tr>
	...
	<td width="156"><div align="center"><strong>Gaji Kotor</strong></div></td>
		...
		$jbt=mysql_fetch_array($nm2);
		  ?>
			<tr align="left" valign="top">
				...
				<td>
					<?php echo "Rp. ".format_rupiah($re[gaji_kotor]); ?>			</td>
                <td align="center">
					<a href="?page=u-gaji&id=<?php echo $re[id_gaji]; ?>&io=Kontrak">Update</a>	
