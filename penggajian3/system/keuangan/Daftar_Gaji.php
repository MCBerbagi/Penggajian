...
<table width="766" class="tbls">
  ...
  <tr>
    ...
    <td width="491"><select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
      ...
      <?php } ?>
      <option value="?page=d-gaji&io=Tetap">Pegawai Tetap</option>
      <option value="?page=d-gaji&io=Kontrak">Pegawai Kontrak</option>
      <option value="?page=d-gaji&io=Buruh">Buruh</option>
    </select></td>
  </tr>
  <tr>
...
-->  <tr>
  ...
  <tr>
    <td>Lembur</td>
    <td><strong>Rp</strong></td>
    <td><input type="text" name="lembur" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();" onKeyPress="return numbersOnly(event, false);" /></td>
  </tr>
  <tr>
    <td>Uang Makan</td>
    <td><strong>Rp</strong></td>
    <td><input type="text" name="makan" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();"onkeypress="return numbersOnly(event, false);" /></td>
  </tr>
  <tr>
    <td>Transportasi</td>
    <td><strong>Rp</strong></td>
    <td><input type="text" name="transportasi" id="TxtBulan"  onFocus="startSum();" onBlur="stopSum();"onkeypress="return numbersOnly(event, false);"/></td>
  </tr>
  <!-- zz -->
  <?php if($_GET[io]=="Tetap" or $_GET[io]=="Kontrak") { ?>
  <tr>
    ...
    <td><strong>Rp</strong></td>
    <td><input name="istri" type="text" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();"onkeypress="return numbersOnly(event, false);"/></td>
  </tr>
  <tr>
    <td><strong>Tunjangan Anak</strong></td>
    <td><strong>Rp</strong></td>
    <td><input type="text" name="anak" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();"onkeypress="return numbersOnly(event, false);"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><strong>Rp</strong></td>
    <td><input type="text" name="kematian" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();" onKeyPress="return numbersOnly(event, false);" readonly/></td>
  </tr>
  <?php } ?>
  <!-- zz -->
  <tr>
    ...
    <td><strong>Rp</strong></td>
    <td><input type="text" name="hari_raya" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();" onKeyPress="return numbersOnly(event, false);" /></td>
  </tr>
  ...
  <tr>
    <td>Bonus</td>
    <td><strong>Rp</strong></td>
    <td><input type="text" name="bonus" id="TxtBulan" onFocus="startSum();" onBlur="stopSum();" onKeyPress="return numbersOnly(event, false);" /></td>
  </tr>
  <tr>
    <td>Potongan</td>
    <td><strong>Rp</strong></td>
