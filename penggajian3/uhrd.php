...
<div class="PageBackgroundSimpleGradient">
    ...
    <div class="Main">
        ...
        <div align="center" id="content">
             ...
             <li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Pegawai</span></a>
                			<ul>
                				<!--<li><a href="?page=HRD">Hrd</a></li>
                				<li><a href="?page=keuangan">Keuangan</a></li>
                				<li><a href="?page=mandor">Mandor</a></li>-->
                				<li><a href="?page=buruh">Buruh</a></li>
                                <li><a href="?page=pegawai">Pegawai Tetap</a></li>
                                <li><a href="?page=kontrak">Pegawai Kontrak</a></li>
                			</ul>
                		</li>
                <li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Kinerja</span></a>
                			<ul>
                				<li><a href="?page=absensi">Data Absensi</a></li>
                				<li><a href="?page=viewlembur">Data Lembur</a></li>
                			</ul>
                		</li>
             <li><a href="?page=viewjenjangkarir"><span class="l"></span><span class="r"></span><span class="t">Jenjang Karir</span></a></li>	
