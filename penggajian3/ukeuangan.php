    ...
    <div class="Main">
        ...
        <div align="center" id="content">
                ...
                <div class="nav">
                	...
                	<ul class="artmenu">
                		<li><a href="ukeuangan.php" class="{ActiveItem}"><span class="l"></span><span class="r"></span><span class="t">Home</span></a></li>
						
                		<li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Penggajian</span></a>
                			<ul>
				<li><a href="?page=d-gaji">Input Gaji</a></li>

                				<li><a href="#">Data Gaji Pegawai</a>
								<ul>
                						<li><a href="?page=gaji-T">Pegawai Tetap</a> </li>
                						<li><a href="?page=gaji-K">Pegawai Kontrak</a> </li>
                						<li><a href="?page=gaji">Buruh</a> </li>
                					</ul>
								</li>
                                 <li><a href="?page=pajak">Pajak</a></li>
                                 <li><a href="?page=gj-bersih">Slip Gaji</a></li>
								 <li><a href="#">Data Slip Gaji</a>
								<ul>
                						<li><a href="?page=slip-T">Pegawai Tetap</a> </li>
                						<li><a href="?page=slip-K">Pegawai Kontrak</a> </li>
                						<li><a href="?page=slip-B">Buruh</a> </li>
                					</ul>
								</li>
                			</ul>
                		</li>
                		<li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Jurnal / Buku Besar</span></a>
							<ul>
									<li><a href="?page=j-gaji">Jurnal Penggajian</a></li>
									<li><a href="?page=j-pph">Jurnal Pajak PPH 21</a></li>
							</ul>
						</li>
...
-->                		
<li><a href="#"><span class="l"></span><span class="r"></span><span class="t">Laporan</span></a>
							<ul>
									<li><a href="?page=L-spt-T">Laporan SPT Tetap</a></li>
									<li><a href="?page=L-spt-K">Laporan SPT Kontrak</a></li>
									<!--<li><a href="?page=d-gaji">Laporan </a></li>-->
							</ul>
						</li>
<li><a href="logout.php?ukeuangan"><span class="l"></span><span class="r"></span><span class="t">Logout</span></a></li>
                	</ul>
                </div>
